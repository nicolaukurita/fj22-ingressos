...
import br.com.caelum.ingresso.dao.DetalhesDoFilme;
...
public class FilmeController {
	...
	public ModelAndView detalhes(@PathVariable("id") Integer id) {
		...
		Optional<DetalhesDoFilme> detalhesDoFilem = client.request(filme,
				DetalhesDoFilme.class);

		modelAndView.addObject("sessoes", sessoes);
		modelAndView.addObject("detalhes",
				detalhesDoFilem.orElse(new DetalhesDoFilme()));
